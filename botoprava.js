            ...
            englishCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        switch(lang){
                            case 'en': break;
                            case 'da': ch += 'VĂ¦r venlig at tale engelsk.'; break;
                            case 'de': ch += 'Bitte sprechen Sie Englisch.'; break;
                            case 'es': ch += 'Por favor, hable InglĂ©s.'; break;
                            case 'fr': ch += 'Parlez anglais, s\'il vous plaĂ®t.'; break;
                            case 'nl': ch += 'Spreek Engels, alstublieft.'; break;
                            case 'pl': ch += 'ProszÄ™ mĂłwiÄ‡ po angielsku.'; break;
                            case 'pt': ch += 'Por favor, fale InglĂŞs.'; break;
                            case 'sk': ch += 'Hovorte po anglicky, prosĂ­m.'; break;
                            case 'cs': ch += 'Mluvte prosĂ­m anglicky.'; break;
                            case 'sr': ch += 'ĐśĐľĐ»Đ¸ĐĽ Đ’Đ°Ń, ĐłĐľĐ˛ĐľŃ€Đ¸Ń‚Đµ ĐµĐ˝ĐłĐ»ĐµŃĐşĐ¸.'; break;
                        }
                        ch += ' English please.';
                        API.sendChat(ch);
                    }
