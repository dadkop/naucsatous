...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/ThEWiShoT/UpTunes/master/lang.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "TunesBot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/ThEWiShoT/UpTunes/master/system.js",
        cmdLink: "http://git.io/245Ppg",
        chatLink: "https://rawgit.com/ThEWiShoT/UpTunes/master/slovak.json",
        chat: null,
        loadChat: loadChat,
        ...
        commands: {
            ...
            cookieCommand: {
                ...
                rank: 'user',
                type: 'startsWith',
                cookies: ['ti daroval/a čokoládovú :cookie:.',
                    'ti daroval/a starú, skazenú :cookie:. Nejedz to!',
                    'ti daroval/a vanilkovú :cookie:. Dobrú chuť.',
                    'ti daroval/a karamelovú :cookie:.',
                    'ti daroval/a svoju štastnú :cookie:. Nechaj si ju na horšie časy.',
                    'ti daroval/a :cookie: na ktorej je lístok "Mám ta rád" :yellow_heart:.',
                    'ti daroval/a :cookie: na ktorej je lístok "Kúp mi Snickers! :v:.',
                    'ti daroval/a :cookie: ktorá je pečená s láskou.',
                    'ti daroval/a :cookie lásky! Ale pozor! Ak ju zješ stratíš starú lasku..gives you a fortune cookie. It reads "Take a risk!"',
                    'ti daroval/a :cookie: na ktorej je lístok "Movni ma na 1.miesto" :blush:!',
                    'ti daroval/a :cookie: na ktorej je lístok "Nejedz ma prosím" :joy:.',
                    'ti chcel/a darovat :cookie:, Ale bola taka úžasná že ju zjedol sám.'
                ],
                getCookie: function () {
            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me Tento System je upravený Užívateľom ThEWiShoT.');
                    }
                }
            },
            ...
            backCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(subChat(basicBot.chat.back, {name: chat.un}));
                    }
                }
            },
           ...
           infoCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(subChat(basicBot.chat.info, {name: chat.un}));
                    }
                }
            },
            ...
            rdjCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(subChat(basicBot.chat.rdj, {name: chat.un}));
                    }
                }
            },
